    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			a = element("a");
    			t = text(/*text*/ ctx[2]);
    			attr_dev(a, "href", a_href_value = "http://" + /*text*/ ctx[2]);
    			add_location(a, file, 43, 3, 956);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			a = element("a");
    			t = text(/*text*/ ctx[2]);
    			attr_dev(a, "href", a_href_value = "http://" + /*url*/ ctx[3]);
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 256, 0, 9085);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
